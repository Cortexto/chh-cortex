...
logged_in_as: Berktuğ Kubuk (support only — NOT PI)
---
...
| # | Field / upload | Portal ref | Status | Notes |
|---|----------------|------------|--------|-------|
| 1 | Applicant First Name | e388 | **filled** | Shatha |
| 2 | Applicant Last Name | e389 | **filled** | Elnakib |
| 3 | Applicant Email | e390 | **filled** | selnaki1@jhu.edu |
| 4 | Applicant JHED ID | e391 | **filled** | selnaki1 (**verify** with Shatha) |
| 5 | Applicant Title (radio) | e394 | **filled** | Assistant Professor |
| 6 | Applicant Department | e396 | **filled** | Center for Humanitarian Health, Department of International Health |
| 7 | Applicant Division | e397 | **filled** | BSPH |
...
| Prior reviews | Not located | — | **verify** |
...
| Institutional open | **pass** — science-gap lead |
| Separate $12M EoI | **pass** — overlap statement in support template |
...
8. **Prior DIV reviews** — verify attachable

---

## Next actions (Berktuğ)

See parent report §3 for prioritized list.

**Red-team pass applied:** Status table reflects all kill-list guards; no false "uploaded" claims.
